...
public class ProduitData implements IData{
	...
	public List<String> getListPiece() {
		return listPiece;
	}
	public void setListPiece(List<String> listPiece) {
	...
	public ProduitData(int id, String name, Map<String, String> mapPiece, List<String> listPiece) {
		super();
		this.id = id;
		this.name = name;
		this.mapPiece = mapPiece;
